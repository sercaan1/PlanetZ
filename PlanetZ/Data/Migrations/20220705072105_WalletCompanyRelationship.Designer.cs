...
namespace PlanetZ.Data.Migrations
{
    ...
    [Migration("20220705072105_WalletCompanyRelationship")]
    partial class WalletCompanyRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CreditCardWallet", b =>
                {
                    ...
                    b.HasKey("CreditCardsId", "WalletsId");

                    b.HasIndex("WalletsId");

                    b.ToTable("CreditCardWallet");
                });
            ...
            modelBuilder.Entity("CreditCardWallet", b =>
                {
                    b.HasOne("PlanetZ.Data.CreditCard", null)
                        .WithMany()
                        .HasForeignKey("CreditCardsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PlanetZ.Data.Wallet", null)
                        .WithMany()
