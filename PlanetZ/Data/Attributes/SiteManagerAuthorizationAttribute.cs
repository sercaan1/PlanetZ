...
{
    public class SiteManagerAuthorizationAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (employee.Role == Enums.EnumRoles.Employee || employee.Role == Enums.EnumRoles.CompanyManager)
            {
